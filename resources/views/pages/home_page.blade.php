...
.my-welding {
  mask: url(assets/welding.svg);
}
.my-engine {
  mask: url(assets/engine.svg);
}
.my-paint {
  mask: url(assets/paint.svg);
}
.my-polish {
  mask: url(assets/polish.svg);
}

.my-crashed {
  mask: url(assets/crashed.svg);
}
.my {
  width: 50px;
  height: 50px;
...
<section id="hero" class="d-flex align-items-center">
  ...
  <main id="main">
    ...
    <!-- ======= Services Section ======= -->
    <section id="services" class="services" style="background-image:linear-gradient(rgb(17, 14, 14), rgb(17, 14, 14, 0.7), rgba(17, 14, 14, 0.6)), url(assets/wallpaper.jpg); background-repeat: no-repeat; background-size: cover; ">
      <div class="container">
